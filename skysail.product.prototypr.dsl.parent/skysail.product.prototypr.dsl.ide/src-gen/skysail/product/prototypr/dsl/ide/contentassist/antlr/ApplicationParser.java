 ...
 */
package skysail.product.prototypr.dsl.ide.contentassist.antlr;
...
import skysail.product.prototypr.dsl.ide.contentassist.antlr.internal.InternalApplicationParser;
...
public class ApplicationParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalApplicationParser createParser() {
		InternalApplicationParser result = new InternalApplicationParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getApplicationAccess().getImportSectionAssignment_0(), "rule__Application__ImportSectionAssignment_0");
					put(grammarAccess.getApplicationAccess().getElementsAssignment_1(), "rule__Application__ElementsAssignment_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			InternalApplicationParser typedParser = (InternalApplicationParser) parser;
