...
:
(
	{ before(grammarAccess.getApplicationAccess().getImportSectionAssignment_0()); }
	(rule__Application__ImportSectionAssignment_0)?
	{ after(grammarAccess.getApplicationAccess().getImportSectionAssignment_0()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
(
	{ before(grammarAccess.getPackageDeclarationAccess().getApplicationKeyword_0()); }
	'application'
	{ after(grammarAccess.getPackageDeclarationAccess().getApplicationKeyword_0()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		{ before(grammarAccess.getApplicationAccess().getImportSectionXImportSectionParserRuleCall_0_0()); }
		ruleXImportSection
		{ after(grammarAccess.getApplicationAccess().getImportSectionXImportSectionParserRuleCall_0_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		{ before(grammarAccess.getApplicationAccess().getElementsAbstractElementParserRuleCall_1_0()); }
		ruleAbstractElement
		{ after(grammarAccess.getApplicationAccess().getElementsAbstractElementParserRuleCall_1_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
