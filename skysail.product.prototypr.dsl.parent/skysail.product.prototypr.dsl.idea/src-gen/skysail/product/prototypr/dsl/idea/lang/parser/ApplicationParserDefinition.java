...
public class ApplicationParserDefinition extends AbstractXtextParserDefinition {
	...
	public PsiElement createElement(ASTNode node) {
		...
		if (hasSemanticElement != null && hasSemanticElement) {
			...
			if (elementType == elementTypeProvider.getApplicationElementType()) {
				return new PsiEObjectImpl(node) {};
			}
			if (elementType == elementTypeProvider.getApplication_ImportSectionXImportSectionParserRuleCall_0_0ElementType()) {
				return new PsiEObjectImpl(node) {};
			}
			if (elementType == elementTypeProvider.getApplication_ElementsAbstractElementParserRuleCall_1_0ElementType()) {
			...
			if (elementType == elementTypeProvider.getEntity_SuperTypeJvmTypeReferenceParserRuleCall_2_1_0ElementType()) {
				return new PsiEObjectImpl(node) {};
			}
			...
			if (elementType == elementTypeProvider.getOperation_TypeJvmTypeReferenceParserRuleCall_6_0ElementType()) {
				return new PsiEObjectImpl(node) {};
			}
			if (elementType == elementTypeProvider.getOperation_BodyXBlockExpressionParserRuleCall_7_0ElementType()) {
				return new PsiEObjectImpl(node) {};
			}
